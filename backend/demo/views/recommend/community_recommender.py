...
class CommunityRecommender:
    ...
    def get_courses_similarity(self, course_a_ids, course_b_ids):
    ...
    def evaluate_course_similarity(self, community):
        ...
        if self.student.completed_courses.exists():
            ...
            completed_course_similarity = self.get_courses_similarity(student_completed_course_ids, wish_course_ids)
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            for future in as_completed(future_to_community):
                ...
                try:
                    ...
                    if similarity_score > self.LOW_ENTER_THRESHOLD:
